...
extension NativeScanner {
    ...
    static func makeFdBuffer() -> [proc_fdinfo] {
        [proc_fdinfo](repeating: proc_fdinfo(), count: 256)
    }

    static func socketListeners(_ pid: Int32, fdBuffer: inout [proc_fdinfo]) -> [Listener] {
    ...
    static func localEndpoint(_ info: in_sockinfo) -> (host: String, port: Int) {
    ...
    static func isZero(_ address: in6_addr) -> Bool {
