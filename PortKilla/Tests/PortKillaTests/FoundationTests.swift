...
final class FoundationTests: XCTestCase {
    ...
    func testFirstFreePortPrefersThePreferredThenScans() {
        ...
        _ = canBind
        XCTAssertEqual(PortKillaCLI.firstFreePort(prefer: 3000, range: 3000...3010, listening: []), 3000)
        XCTAssertEqual(PortKillaCLI.firstFreePort(prefer: 3000, range: 3000...3010, listening: [3000, 3001]), 3002)
        XCTAssertNil(PortKillaCLI.firstFreePort(prefer: 3000, range: 3000...3001, listening: [3000, 3001]))
    }
