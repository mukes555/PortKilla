...
final class ManagedRuntimeTests: XCTestCase {
    ...
    func testToolLocatorSearchesPathThenCommonDirectories() throws {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("portkilla-tools-\(UUID().uuidString)")
    ...
    func testRefusalsAreStoredApartFromKills() throws {
        let suite = "com.mukes555.PortKilla.tests.\(UUID().uuidString)"
