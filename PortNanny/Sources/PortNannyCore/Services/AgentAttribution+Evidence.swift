...
/// Why PortNanny attributed a process the way it did: the ancestors it
...
public struct AttributionEvidence: Encodable {
    ...
    /// PORTNANNY_OWNER as found in the environment, before canonicalising.
...
extension AgentAttribution {
    ...
    public static func explain(pid: Int, in processes: ProcessTable,
        ...
        return AttributionEvidence(
            declaredOwner: AgentSignatures.declaredOwner(in: environment),
            declaredSession: AgentSignatures.declaredSession(in: environment),
