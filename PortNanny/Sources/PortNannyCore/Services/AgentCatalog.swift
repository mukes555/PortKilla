...
public enum AgentCatalog {
    ...
    static let notes: [String: Note] = [
        ...
        "Codex CLI": Note(
            ...
            tip: "export PORTNANNY_SESSION=<anything unique per session> before starting servers to keep two Codex sessions apart"),
        "Gemini CLI": Note(
            ...
            tip: "export PORTNANNY_SESSION=<anything unique per session> to pin detached servers to a session"),
        "Copilot CLI": Note(
            session: "pid while attached; nothing survives reparenting",
            provenance: "executable name only; no environment marker is known",
            tip: "export PORTNANNY_OWNER=copilot and PORTNANNY_SESSION=<unique> before starting servers"),
        "OpenCode": Note(
            session: "pid while attached; nothing survives reparenting",
            provenance: "executable name only; no environment marker is known",
            tip: "export PORTNANNY_OWNER=opencode and PORTNANNY_SESSION=<unique> before starting servers"),
        "Aider": Note(
            session: "pid while attached; nothing survives reparenting",
            provenance: "executable name only; no environment marker is known",
            tip: "export PORTNANNY_OWNER=aider and PORTNANNY_SESSION=<unique> before starting servers"),
        "Cursor": Note(
        ...
        "VS Code": Note(
            ...
            tip: "Copilot agent mode leaves no marker; export PORTNANNY_OWNER=copilot in its terminal to be identified"),
        "Windsurf": Note(
            session: "none: a terminal, not an agent",
            provenance: "Windsurf.app in the tree, or TERM_PROGRAM=vscode with VSCODE_GIT_ASKPASS_* pointing into Windsurf.app",
            tip: "Cascade leaves no marker; export PORTNANNY_OWNER=windsurf in its terminal"),
        "Zed": Note(
            session: "none: a terminal, not an agent",
        ...
        "Trae": Note(
            ...
            tip: "export PORTNANNY_OWNER=trae in its terminal"),
    ]
