...
public enum MemoryFormat {
    public static func string(kilobytes: Int) -> String {
...
public enum ElapsedFormat {
    ...
    public static func humanize(seconds total: Int) -> String? {
    ...
    public static func seconds(fromEtime etime: String) -> Int? {
